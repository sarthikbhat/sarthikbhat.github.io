...
const Header = () => {
    return (
        <nav className="navbar navbar-expand-lg navbar-light">
            ...
            <a href='https://github.com/sarthikbhat/' target='_BLANK' rel="noreferrer"><i className="fab fa-github fa-2x social-icons mx-2"></i></a>
            <a href='https://www.linkedin.com/in/sarthik-bhat-8333a6169/'target='_BLANK' rel="noreferrer"><i className="fab fa-linkedin fa-2x social-icons mx-2"></i></a>
            <a href='https://www.hackerrank.com/bhatsarthik28?hr_r=1' target='_BLANK' rel="noreferrer"><i className="fab fa-hackerrank fa-2x social-icons mx-2"></i></a>
            <a href='mailto:bhatsarthik28@gmail.com' className='d-sm-none'><i className="fas fa-envelope fa-2x social-icons mx-2"></i></a>
            </div>
